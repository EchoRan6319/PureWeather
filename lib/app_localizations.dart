...
class AppLocalizations {
  ...
  static const Map<String, String> _enUs = <String, String>{
    ...
    'AI 服务': 'AI Service',
    '天气助手使用您自行配置的模型与接口':
        'The weather assistant uses the model and endpoint you configure.',
    '用户协议': 'User Agreement',
    '隐私政策': 'Privacy Policy',
